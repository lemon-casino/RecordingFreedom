...
export const mediaInventory: MediaInventory = {
  ...
  microphones: [
    ...
    {
      id: 'microphone:studio-usb',
      type: 'microphone',
      name: 'Studio USB Mic',
      meta: 'USB capture endpoint',
      available: true,
      capability: 'enumerated',
      rnnoiseEligible: true,
    },
    {
      id: 'microphone:virtual-broadcast',
      type: 'microphone',
      name: 'Virtual Broadcast Mic',
      meta: 'Virtual capture endpoint',
      available: true,
      capability: 'enumerated',
      rnnoiseEligible: true,
    },
