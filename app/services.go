...
type RecordingFreedomService struct {
	...
	annotationSourceSessionID  string
	annotationSourceDataURL    string
	annotationSourceCapturedAt string
	annotationRenderMu         sync.Mutex
	annotationRenderBatch      *annotationRenderBatch
	regionMu                   sync.Mutex
	regionSession              *RegionSelectionSession
	regionFrameState           RegionFrameState
	regionFrameVisible         bool
