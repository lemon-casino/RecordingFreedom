...
var RequiredCaptureSteps = []CaptureStep{
	...
	},
	{
		...
		Title:                 "Selected window OCR",
		SourceKind:            string(ocr.SourceWindowScreenshot),
		VisualRequirement:     "window screenshot capture",
		RecommendedVisualFile: "window-screenshot-capture.png",
		Action:                "Use the explicit selected-window screenshot flow. Do not reuse the focused-window capture. Queue OCR, open the result panel, and read the result image.",
		RequiredLogEvents:     sourceKindLogEvents(ocr.SourceWindowScreenshot),
		Acceptance:            sourceKindAcceptance("selected window screenshot", "window-screenshot-capture.png"),
	},
	{
		ID:                    "focused-window-screenshot",
		Title:                 "Focused window OCR",
		SourceKind:            string(ocr.SourceFocusedWindowScreenshot),
		VisualRequirement:     "focused window screenshot capture",
		RecommendedVisualFile: "focused-window-screenshot-capture.png",
		Action:                "Focus a target app, use the focused-window screenshot flow, queue OCR, open the result panel, and read the result image.",
		RequiredLogEvents:     sourceKindLogEvents(ocr.SourceFocusedWindowScreenshot),
		Acceptance:            sourceKindAcceptance("focused window screenshot", "focused-window-screenshot-capture.png"),
	},
	{
...
var RequiredVisualEvidence = []VisualRequirement{
	...
	{
		Name:            "window screenshot capture",
		Terms:           []string{"window", "screenshot"},
		Exclude:         []string{"focused"},
		RecommendedFile: "window-screenshot-capture.png",
		Description:     "Explicit selected window screenshot result. Do not use the focused-window shot for this item.",
		MinWidth:        480,
		MinHeight:       260,
	},
	{
		Name:            "focused window screenshot capture",
		Terms:           []string{"focused", "window"},
		RecommendedFile: "focused-window-screenshot-capture.png",
		Description:     "Focused-window screenshot result after changing focus to the target application.",
		MinWidth:        480,
		MinHeight:       260,
	},
	{
