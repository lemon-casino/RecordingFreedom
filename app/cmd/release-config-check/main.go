...
var releaseConfigChecks = []configCheck{
	...
	},
	{
		...
		Needles: []string{
			...
			"cgo_enabled: \"0\"",
			"rnnoise_native: \"false\"",
			"RNNoise native DSP is compiled into Windows x64, macOS x64/arm64, and Linux x64/arm64 artifacts",
			"Windows ARM64 is published as a native ARM64 recorder package without rnnoise_native",
		},
	},
	{
		File: ".github/workflows/release.yml",
